"""The `Persistence` bundle — single injection point for the four
...
Internally the four Protocols stay separate (see
...
@dataclass
class Persistence:
    """Bundle of the four persistence Protocols passed as
    ...
    def supabase(
        ...
        **direct connection**, port 5432) with an `S3BlobStore` (against
        ...
        return cls(
            task_log=pg, participant_store=pg, blob_store=blobs, memory_store=pg,
        )
