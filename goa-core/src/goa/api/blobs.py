...
from goa.errors import BlobForbidden, BlobNotFound, TaskNotFound
...
@router.post("/tasks/{task_id}/blobs", status_code=201, response_model=Attachment)
...
@router.get("/blobs/{blob_id}/meta", response_model=Attachment)
